...
import projet.carte.CarteCreationActivity;
import projet.R;
import projet.general.CommunicationServeur;

public class CreationEvenementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(CreationEvenementActivity.this, CarteCreationActivity.class);
        ...
        heuredebut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(CreationEvenementActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        dateevenement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker;
                    mDatePicker = new DatePickerDialog(CreationEvenementActivity.this, new DatePickerDialog.OnDateSetListener() {
        ...
        img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(CreationEvenementActivity.this, MenuActivity.class);
                startActivity(myIntent);
            }
        });
    ...
    class MyTimerTask extends TimerTask {
        public void run() {
            Intent myIntent = new Intent(CreationEvenementActivity.this, EvenementService.class);
    ...
    public void ShowAlertDialogWithListview() throws JSONException {
        ...
        */
        ...
        Spinner spinner = new Spinner(CreationEvenementActivity.this);
        ...
        ArrayAdapter<String> adapter =new ArrayAdapter<String>(CreationEvenementActivity.this,R.layout.activity_creation, sportArray);
    ...
    private class PostClass extends AsyncTask<String, Void, String> {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(CreationEvenementActivity.this, R.style.AppTheme_Dark_Dialog);
