...
import projet.carte.CarteActivity;
import projet.R;
import projet.utilisateur.ParametreUtilisateur;
...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(MenuActivity.this, CreationEvenementActivity.class);
        ...
        parametreUtilisateur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(MenuActivity.this, ParametreUtilisateur.class);
                startActivity(myIntent);
            }
        });
        ...
        imgJoin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(MenuActivity.this, CarteActivity.class);
                startActivity(myIntent);
            }
        });
    }
    ...
    class MyTimerTask extends TimerTask {
        public void run() {
            Intent myIntent = new Intent(MenuActivity.this, EvenementService.class);
