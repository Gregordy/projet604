...
/**
 * Classe / Activité permettant l'inscription de l'utilisateur et la redirection
 * vers le système de connexion
 */
public class InscriptionActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        _loginLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Finish the registration screen and return to the ConnexionActivity activity
                finish();
            }
        });
    }
    ...
    private class PostClass extends AsyncTask<String, Void, String> {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(InscriptionActivity.this, R.style.AppTheme_Dark_Dialog);
                ...
                if (info[i].getState() == NetworkInfo.State.CONNECTED) {
                    ...
                    try {
                        ...
                        Uri.Builder builder = new Uri.Builder()
                                .appendQueryParameter("OBJET", "InscriptionActivity")
