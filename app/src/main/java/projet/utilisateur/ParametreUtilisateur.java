...
public class ParametreUtilisateur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date_de_naissance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatePicker = new DatePickerDialog(ParametreUtilisateur.this, new DatePickerDialog.OnDateSetListener() {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(ParametreUtilisateur.this, MenuActivity.class);
    ...
    class MyTimerTask extends TimerTask {
        public void run() {
            Intent myIntent = new Intent(ParametreUtilisateur.this,EvenementService.class);
