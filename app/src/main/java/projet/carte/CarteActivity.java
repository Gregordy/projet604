...
import projet.sport.SportEventGroup;
...
public class CarteActivity extends FragmentActivity implements OnMapReadyCallback, OnInfoWindowClickListener, LocationListener {
    ...
    class MyTimerTask extends TimerTask {
        public void run() {
            Intent myIntent = new Intent(CarteActivity.this,EvenementService.class);
    ...
    private class PostClassMapJoin extends AsyncTask<SportEventGroup, SportEventGroup, SportEventGroup> {
        final ProgressDialog progressDialog = new ProgressDialog(CarteActivity.this, R.style.AppTheme_Dark_Dialog);
    ...
    private class PostClassJoin extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String th) {
            ...
            if(th.equals("true")){
                ...
                Intent myIntent = new Intent(CarteActivity.this, MenuActivity.class);
