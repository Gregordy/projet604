...
import projet.R;
import projet.sport.SportField;
import projet.sport.SportFieldGroup;
import projet.application.CreationEvenementActivity;
import projet.application.EvenementService;
import projet.general.InputStreamOperations;
...
/**
 * VOIR LES COMMENTAIRES DE CarteActivity SI BESOIN
 */


public class CarteCreationActivity extends FragmentActivity implements OnMapReadyCallback, OnInfoWindowClickListener, LocationListener,OnMarkerClickListener {
    ...
    class MyTimerTask extends TimerTask {
        public void run() {
            Intent myIntent = new Intent(CarteCreationActivity.this,EvenementService.class);
    ...
    public void onInfoWindowClick(Marker marker) {
        ...
        Intent intent = new Intent(CarteCreationActivity.this, CreationEvenementActivity.class);
    ...
    private class PostClassCreate extends AsyncTask<SportFieldGroup, SportFieldGroup, SportFieldGroup> {
        final ProgressDialog progressDialog = new ProgressDialog(CarteCreationActivity.this, R.style.AppTheme_Dark_Dialog);
