...
import projet.utilisateur.Connexion;

public class Login$$ViewBinder<T extends Connexion> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558544, "field '_emailText'");
    target._emailText = finder.castView(view, 2131558544, "field '_emailText'");
